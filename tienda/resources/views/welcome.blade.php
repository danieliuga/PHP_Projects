    ...
    <style>
        ...
        *,
        ...
        nav {
            ...
            top: 0;
            left: 0;
            background-color: rgb(113, 162, 239);
            width: 15%;
            height: 100%;
            text-align: center;
...
<body>
    <div class="main">
        ...
        <header>
            <h1>Supercars Shop</h1>
        </header>

        <div class="product1">
            <h2>Coches en Venta</h2>
            <img src="{{ asset('img/porsche_911.jpg') }}" alt="Imagen de coche" class="foto" />
            <div class="coche">
                <a href="/venta/coche">Venta de Coches</a>
            </div>
        </div>

        <div class="product2">
            <h2>Motos en Venta</h2>
            <img src="{{ asset('img/h2r-kawasaki.jpg') }}" alt="Imagen de moto" class="foto" />
            <div class="moto">
                <a href="/venta/moto">Venta de Motos</a>
            </div>
        </div>

        <footer>
            <p>¡Gracias por visitar Supercars Shop! Explora nuestras ofertas exclusivas.</p>
            <a href="/contact" class="contact-btn">Contactar</a>
        </footer>
