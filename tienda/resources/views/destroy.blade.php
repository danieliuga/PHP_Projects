...
<body class="font-sans bg-gradient-to-r from-blue-300 to-blue-600 m-0 p-0 overflow-y-hidden">
    <div class="mx-auto px-4 py-20">
        ...
        <form action="{{ route('modificar.destroy') }}" method="post" class="bg-white p-6 rounded-lg shadow-md mb-36 mt-6">
            @csrf
            @method('delete')
            <div class="mb-4">
            ...
            <button type="submit" class="px-6 py-2 rounded-md bg-blue-500 text-white hover:bg-blue-600 transition-colors duration-300">Eliminar Vehículo</button>
        </form>        
