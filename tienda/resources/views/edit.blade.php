...
<body class="font-sans bg-gradient-to-r from-blue-300 to-blue-600 m-0 p-0">
    <div class="mx-auto px-4 py-20">
        ...
        <header class="bg-gradient-to-r from-blue-500 to-blue-400 py-5 px-4 rounded-b-lg text-center -mt-14">
            <h1 class="text-white text-3xl font-bold tracking-wide mb-4">Editar Moto</h1>
        ...
        <form action="{{ route('modificar.update') }}" method="post" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md mb-6 mt-6">
            @csrf
            @method('put')
            <div class="mb-6">
                <label for="vehiculo_id" class="block font-bold mb-1">Selecciona un vehículo:</label>
                <select class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500" id="vehiculo_id" name="vehiculo_id">
            ...
            <button type="submit" class="px-6 py-2 rounded-md bg-blue-500 text-white hover:bg-blue-600 transition-colors duration-300">Actualizar Vehículo</button>
        </form>        
