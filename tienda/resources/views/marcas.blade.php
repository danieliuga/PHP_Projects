...
<body class="font-sans m-0 p-0 bg-gradient-to-r from-blue-300 to-blue-600">
    <div class="mx-auto px-4 py-20">
        ...
        <header class="bg-gradient-to-r from-blue-500 to-blue-400 py-5 px-4 rounded-b-lg text-center -mt-14">
            <h1 class="text-white text-3xl font-bold tracking-wide mb-4">Marcas Vehiculos</h1>
            <div class="flex items-center justify-around bg-blue-500 w-64 h-10 rounded-lg shadow-lg mx-auto">
                <a href="/">
                    <button class="button w-10 h-10 rounded-full bg-transparent text-white flex items-center justify-center transition-transform duration-300 ease-in-out cursor-pointer">
                ...
                <a href="/valoraciones">
                    <button class="button w-10 h-10 rounded-full bg-transparent text-white flex items-center justify-center transition-transform duration-300 ease-in-out cursor-pointer">
                        <svg viewBox="0 0 64 64"
                            ...
                            <path d="m32 24.98757 5.03973 1.79213a1.382 1.382 0 0 0 1.84451-1.34011l-.14705-5.34687 3.26181-4.23928a1.382 1.382 0 0 0 -.70454-2.16835l-5.13062-1.51241-3.02384-4.41215a1.382 1.382 0 0 0 -2.27994 0l-3.02384 4.41215-5.13062 1.51241a1.382 1.382 0 0 0 -.70454 2.16835l3.26178 4.23928-.14705 5.34687a1.382 1.382 0 0 0 1.84451 1.34011z"
                                fill="#4aa5ff" />
                            <g fill="#e6f3ff">
                                <path d="m10 38h8a3 3 0 0 1 3 3v15a0 0 0 0 1 0 0h-14a0 0 0 0 1 0 0v-15a3 3 0 0 1 3-3z" />
                                <path d="m46 35h8a3 3 0 0 1 3 3v18a0 0 0 0 1 0 0h-14a0 0 0 0 1 0 0v-18a3 3 0 0 1 3-3z" />
        ...
        <div class="grid grid-cols-3 gap-4 w-full max-w-full mt-10 mb-10">
            @foreach ($marcas as $marca)
                <div class="car-listing">
                    <img src="{{ asset($marca->imagen) }}" alt="{{ $marca->modelo }}" class="mx-auto object-contain h-48 max-w-full" />
                    <h3 class="mt-4 text-gray-900 mb-4">{{ $marca->modelo }}</h3>
                    <p class="text-gray-600 flex-grow mb-4">País de Origen: {{ $marca->pais_origen }}</p>
                    <p class="text-gray-600 flex-grow mb-4">Descripción: {{ $marca->descripcion }}</p>
                    <a href="{{ $marca->link }}" class="block py-2 px-4 bg-blue-500 text-white rounded-md transition-colors duration-300 ease-in-out text-center hover:bg-blue-600" @guest disabled @endguest>
                        Ver Más
                    </a>
                </div>
            @endforeach
