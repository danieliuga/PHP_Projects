...
<body class="font-sans bg-gradient-to-r from-blue-300 to-blue-600 m-0 p-0">
    <div class="mx-auto px-4 py-20">
        ...
        <header class="bg-gradient-to-r from-blue-500 to-blue-400 py-5 px-4 rounded-b-lg text-center -mt-14">
            <h1 class="text-white text-3xl font-bold tracking-wide mb-4">Contactar</h1>
        ...
        <form method="post" action="{{ route('contact.submit') }}" class="bg-white p-6 rounded-lg shadow-md mb-6">
            @csrf

            <label for="nombre" class="block mb-2 font-bold">Nombre:</label>
            <input type="text" name="nombre" required
                class="w-full px-4 py-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
            ...
            <textarea name="mensaje" required
                class="w-full px-4 py-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 resize-none"></textarea>

            <button type="submit" class="px-6 py-2 rounded-md bg-blue-500 text-white hover:bg-blue-600 transition-colors duration-300">Enviar</button>
            </form>
